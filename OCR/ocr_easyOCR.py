...
def processar_intervalo(writer: csv.DictWriter, reader: easyocr.Reader,
    ...
    for idx in escolhidos:
        ...
        writer.writerow({
            ...
            "confianca_placa": round(confianca_placa, 2)
        })
...
def main():
    ...
    campos = ["intervalo", "texto_bruto", "texto_limpo", "placa", "confianca_ocr", "confianca_letras", "confianca_placa"]
